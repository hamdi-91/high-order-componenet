...
<div className="d-flex justify-content-between">
        ...
        <Movielist isLoading={this.state.isLoading} x={this.state.list.filter(el => el.rating >= this.state.newRating && el.title.toUpperCase().includes(this.state.keyword.toUpperCase().trim())) } />
